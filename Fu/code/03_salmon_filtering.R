...
mj001_data <- counts(loadFry("../salmon/MJ001/MJ001_quant_res", outputFormat = "snRNA")) #1
mj002_data <- counts(loadFry("../salmon/MJ002/MJ002_quant_res", outputFormat = "snRNA")) #2
mj003_data <- counts(loadFry("../salmon/MJ003/MJ003_quant_res", outputFormat = "snRNA")) #3
mj005_data <- counts(loadFry("../salmon/MJ005/MJ005_quant_res", outputFormat = "snRNA")) #4
mj006_data <- counts(loadFry("../salmon/MJ006/MJ006_quant_res", outputFormat = "snRNA")) #5
mj007_data <- counts(loadFry("../salmon/MJ007/MJ007_quant_res", outputFormat = "snRNA")) #12
mj008_data <- counts(loadFry("../salmon/MJ008/MJ008_quant_res", outputFormat = "snRNA")) #6
mj009_data <- counts(loadFry("../salmon/MJ009/MJ009_quant_res", outputFormat = "snRNA")) #7

mj016_data <- counts(loadFry("../salmon/MJ016/MJ016_quant_res", outputFormat = "snRNA")) #8
mj017_data <- counts(loadFry("../salmon/MJ017/MJ017_quant_res", outputFormat = "snRNA")) #9
mj018_data <- counts(loadFry("../salmon/MJ018/MJ018_quant_res", outputFormat = "snRNA")) #10
mj019_data <- counts(loadFry("../salmon/MJ019/MJ019_quant_res", outputFormat = "snRNA")) #11

# translate ensembl IDs to gene symbols
id_to_name <- read.table("~/splici_references/GRCh38-2020-A_geneid_to_name.txt", header = FALSE, stringsAsFactors = FALSE)
mapping <- setNames(id_to_name$V2, id_to_name$V1)

mj001_gene_names <- mapping[mj001_data@Dimnames[[1]]]
mj001_data@Dimnames[[1]] <- mj001_gene_names

mj002_gene_names <- mapping[mj002_data@Dimnames[[1]]]
mj002_data@Dimnames[[1]] <- mj002_gene_names

mj003_gene_names <- mapping[mj003_data@Dimnames[[1]]]
mj003_data@Dimnames[[1]] <- mj003_gene_names

mj005_gene_names <- mapping[mj005_data@Dimnames[[1]]]
mj005_data@Dimnames[[1]] <- mj005_gene_names

mj006_gene_names <- mapping[mj006_data@Dimnames[[1]]]
mj006_data@Dimnames[[1]] <- mj006_gene_names

mj007_gene_names <- mapping[mj007_data@Dimnames[[1]]]
mj007_data@Dimnames[[1]] <- mj007_gene_names

mj008_gene_names <- mapping[mj008_data@Dimnames[[1]]]
mj008_data@Dimnames[[1]] <- mj008_gene_names

mj009_gene_names <- mapping[mj009_data@Dimnames[[1]]]
mj009_data@Dimnames[[1]] <- mj009_gene_names

mj016_gene_names <- mapping[mj016_data@Dimnames[[1]]]
mj016_data@Dimnames[[1]] <- mj016_gene_names

mj017_gene_names <- mapping[mj017_data@Dimnames[[1]]]
mj017_data@Dimnames[[1]] <- mj017_gene_names

mj018_gene_names <- mapping[mj018_data@Dimnames[[1]]]
mj018_data@Dimnames[[1]] <- mj018_gene_names

mj019_gene_names <- mapping[mj019_data@Dimnames[[1]]]
mj019_data@Dimnames[[1]] <- mj019_gene_names
...
mj007_me <- RenameCells(mj007_me, new.names = paste0(colnames(x = mj007_me), "-1_12"))
...
mj001_me <- RenameCells(mj001_me, new.names = paste0(colnames(x = mj001_me), "-1_1"))
mj002_me <- RenameCells(mj002_me, new.names = paste0(colnames(x = mj002_me), "-1_2"))
mj003_me <- RenameCells(mj003_me, new.names = paste0(colnames(x = mj003_me), "-1_3"))
mj005_me <- RenameCells(mj005_me, new.names = paste0(colnames(x = mj005_me), "-1_4"))
mj006_me <- RenameCells(mj006_me, new.names = paste0(colnames(x = mj006_me), "-1_5"))
mj008_me <- RenameCells(mj008_me, new.names = paste0(colnames(x = mj008_me), "-1_6"))
mj009_me <- RenameCells(mj009_me, new.names = paste0(colnames(x = mj009_me), "-1_7"))
mj016_me <- RenameCells(mj016_me, new.names = paste0(colnames(x = mj016_me), "-1_8"))
mj017_me <- RenameCells(mj017_me, new.names = paste0(colnames(x = mj017_me), "-1_9"))
mj018_me <- RenameCells(mj018_me, new.names = paste0(colnames(x = mj018_me), "-1_10"))
mj019_me <- RenameCells(mj019_me, new.names = paste0(colnames(x = mj019_me), "-1_11"))
...
saveRDS(integrated8.rpca,'../data/fu_salmon_preprocessed.rds')
