...
main='~/Mathew/code/02_filtering_and_preprocessing/cellranger'
...
#####################
mkdir $main/'01_qc'
Rscript $script_path/00_load_data_cellranger.R \
--input_path '../../cellranger' \
